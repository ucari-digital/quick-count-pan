...
<div class="page-content__header">
	<div>
		<h2 class="page-content__header-heading">Kordinator RTRW</h2>
	</div>
	@if($auth->posisi == 'superadmin' || $auth->posisi == 'kelurahan')
	<div class="page-content__header-meta">
		<a href="{{url('kordinator/rtrw/create')}}" class="btn btn-info icon-left">
			Tambah
		</a>
	</div>
	@endif
	...
	<div class="col-md-12 mb-3">
		<div class="order-collapse gray">
			...
			<div class="collapse show order-collapse-inner" id="collapse3">
				<form action="{{url('kordinator/rtrw/search')}}" method="post" class="p-3">
					@csrf
					<div class="row">
						<div class="col-md-5">
